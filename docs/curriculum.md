# Currículo: Módulo 0614 — Despliegue de Aplicaciones Web
...
- i) Se han documentado los procesos de instalación y configuración realizados.

### RA2 — Administración de servidores web
> Implanta aplicaciones web en servidores web, evaluando y aplicando criterios de configuración para su funcionamiento seguro.
...
### RA3 — Administración de servidores de aplicaciones
...
### RA4 — Servidores de transferencia de archivos
...
- g) Se ha elaborado documentación relativa a la configuración y administración del servicio.
- h) Se han utilizado tecnologías de virtualización en el despliegue de servidores de transferencia de archivos.

### RA5 — Servicios de red implicados en el despliegue
...
- h) Se han utilizado tecnologías de virtualización en el despliegue de servidores de directorios.

### RA6 — Documentación, control de versiones e integración continua
> Elabora la documentación de la aplicación web evaluando y seleccionando herramientas de generación de documentación, control de versiones y de integración continua.
