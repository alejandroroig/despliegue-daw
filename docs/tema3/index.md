# 🌐 Tema 3: Administración de servidores web
...
✅ Se ha elaborado documentación relativa a la configuración y administración segura del servidor.

✅ Se han realizado los ajustes necesarios para la implantación de aplicaciones en el servidor web.

✅ Se han utilizado tecnologías de virtualización en el despliegue de servidores web.

✅ Se han instalado, configurado y utilizado conjuntos de herramientas de gestión de logs.
